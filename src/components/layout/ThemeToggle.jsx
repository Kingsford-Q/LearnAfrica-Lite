...
export function ThemeToggle() {
  ...
  return (
    <div
      onClick={toggleTheme}
      className="group flex md:h-9 h-14 cursor-pointer items-center md:justify-center rounded-lg bg-card border border-input px-3 shadow-sm  focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
    >

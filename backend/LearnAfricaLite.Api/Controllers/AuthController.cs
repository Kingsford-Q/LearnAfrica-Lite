    ...
    ILogger<AuthController> logger) : ControllerBase
{
    ...
    private async Task<AuthResponse> IssueTokensAsync(ApplicationUser user)
    {
        ...
        Response.Cookies.Append(RefreshCookieName, rawRefresh, new CookieOptions
        {
            HttpOnly = true,
            Secure = true,
    ...
    internal static async Task NotifyAsync(AppDbContext db, Guid userId, NotificationType type, string title, string message, string? dedupeKey = null)
    {
